const POINTS = [
  { name: "Красноярск", x: 68.5, y: 6.6 },
  { name: "Монголия", x: 74.5, y: 18.4 },
  { name: "Китай", x: 78.6, y: 28.9 },
  { name: "Мьянма", x: 77.2, y: 38.8 },
  { name: "Таиланд", x: 77.2, y: 47.2 },
  { name: "Индонезия", x: 78.4, y: 60.2 },
  { name: "Филиппины", x: 89.6, y: 50.1 },
  { name: "Перу", x: 7.2, y: 59.4 },
  { name: "Бразилия", x: 25.2, y: 63.1 },
  { name: "Камерун", x: 34.3, y: 55.8 },
  { name: "Уганда", x: 44.4, y: 56.6 },
  { name: "Сомали", x: 51.4, y: 63.8 },
  { name: "Индия", x: 58.5, y: 39.6 },
  { name: "Узбекистан", x: 53.2, y: 21.6 },
  { name: "Красноярск", x: 68.5, y: 6.6 },
];
